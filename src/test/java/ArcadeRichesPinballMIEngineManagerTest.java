...
public class ArcadeRichesPinballMIEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ArcadeRichesPinballMIEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ArcadeRichesPinballMIIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ArcadeRichesPinballMIIW/InitOutcome.xml").getDocumentElement();
